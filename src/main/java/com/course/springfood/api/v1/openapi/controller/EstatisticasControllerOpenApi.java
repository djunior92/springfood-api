...
import com.course.springfood.api.v1.controller.EstatisticasController.EstatisticasModel;
...
public interface EstatisticasControllerOpenApi {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "dataCriacaoInicio", value = "Data/hora inicial da criação do pedido",
                    example = "2021-12-11T00:00:00Z", dataType = "date-time"),
            @ApiImplicitParam(name = "dataCriacaoFim", value = "Data/hora final da criação do pedido",
                    example = "2021-12-12T23:59:59Z", dataType = "date-time")
    })
